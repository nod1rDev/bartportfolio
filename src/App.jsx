      ...
      <div className="flex flex-col md:gap-4 w-full md:w-1/4 justify-between">
        ...
        <div className="flex-0 bg-[#101010] border border-[#101010] p-5 rounded-[23px] h-[14%] items-center flex justify-between mt-4 md:mt-0">
          <button
            ...
            className="px-5  py-[16px] max-h-[56px] w-[56%] hover:shadow-white shadow-md transition-all duration-700 rounded-[30px] bg-white text-black text-center text-[1.1rem] font-[700]"
          >
            Contact me
          </button>
          <a href="https://free-war-fb9.notion.site/Professional-Portfolio-Bart-16137663196080489062f257bb6773fc?pvs=4">
            <button className="bg-[#ffffff1a] w-[100%] h-[56px]  max-h-[56px] py-[16px] font-bold text-[0.8rem] rounded-[30px] px-[34px] hover:border hover:border-white transition-all duration-700 hover:bg-opacity-[50%]">
              GET MY CV
            </button>
          </a>
        </div>
